...
type CommandWithChoices<T> = T & {
    choices?: Array<ApplicationCommandOptionChoiceStructure>;
};
export type CommandWithAutocomplete<T> = T & {
    autocomplete?: boolean;
};
export type ApplicationCommandOptionStructure = ChannelApplicationCommandOptionStructure | CommandWithChoices<StringApplicationCommandOptionStructure> | CommandWithAutocomplete<StringApplicationCommandOptionStructure> | CommandWithChoices<NumericApplicationCommandOptionStructure> | CommandWithAutocomplete<NumericApplicationCommandOptionStructure> | SubCommandApplicationCommandOptionStructure | BaseApplicationCommandOptionStructure;
