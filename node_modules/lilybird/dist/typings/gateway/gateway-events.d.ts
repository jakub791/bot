...
import type { ApplicationCommandPermissionsStructure, AutoModerationActionStructure, AutoModerationRuleStructure, GuildScheduleEventStructure, UnavailableGuildStructure, StageInstanceStructure, AuditLogEntryStructure, ThreadChannelStructure, ThreadMemberStructure, GuildMessageStructure, IntegrationStructure, GuildMemberStructure, ApplicationStructure, InteractionStructure, BotActivityStructure, VoiceStateStructure, ActivityStructure, ChannelStructure, StickerStructure, GuildStructure, EmojiStructure, UserStructure, RoleStructure, NewGuildStructure } from "../index.js";
...
export interface GuildCreate extends DispatchPayload {
    d: UnavailableGuildStructure | NewGuildStructure;
